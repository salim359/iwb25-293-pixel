      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl lg:text-6xl font-bold bg-gradient-to-r from-violet-600 via-violet-500 to-violet-400 bg-clip-text text-transparent mb-6">
            The Pixel AI Advantage
          </h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Discover how Pixel AI transforms your study experience with instant
            generation, smart personalization, and lasting results.
          </p>
        </div>
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-sm font-semibold uppercase tracking-wide">
                    Pixel AI: Instant Smart Study
                  </span>
                </div>
                <p className="text-3xl lg:text-5xl xl:text-6xl font-bold leading-tight">
                  <span className="font-[Caveat] text-white">Pixel AI</span>{" "}
                  gives you instant flashcards, quizzes, and exam predictions
                  from any text or PDF. Study smarter, faster, and more
                  efficiently—powered by AI.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative bg-white border border-violet-200 rounded-3xl p-8 text-gray-800 h-full transform transition-all duration-500 hover:scale-[1.02] hover:shadow-xl hover:border-violet-300 overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Generate high-quality flashcards instantly from any text or
                  PDF. Pixel AI's smart engine extracts key concepts and
                  definitions for rapid revision.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative bg-gradient-to-br from-violet-700 via-violet-600 to-violet-500 rounded-3xl p-8 text-white h-full transform transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl lg:text-3xl font-bold mb-4">
                  Lasting Knowledge, Real Results
                </h3>
                <p className="text-violet-100 leading-relaxed">
                  Pixel AI helps you master concepts for life, not just exams.
                  Build deep understanding and confidence for every academic
                  challenge.
                </p>
              </div>
            </div>
