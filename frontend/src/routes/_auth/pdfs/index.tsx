          ...
          {pdfQuery.isLoading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
              {pdfQuery.data.map((pdf: any) => (
                <Link to="/pdfs/show" search={{ pdf_id: pdf.id }} key={pdf.id}>
                  <Card className="group relative overflow-hidden border border-neutral-100 shadow-md hover:shadow-xl transition-all duration-300 transform bg-gradient-to-br from-white via-gray-50/50 to-primary/5 dark:from-gray-900 dark:via-gray-800/50 dark:to-primary/10">
